    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('disposer', 'Disposer'), ('recycler', 'Recycler'), ('admin', 'Admin')], default='disposer', max_length=20)),
                ('location_lat', models.FloatField(blank=True, null=True)),
                ('location_lng', models.FloatField(blank=True, null=True)),
                ('address_location', models.CharField(blank=True, max_length=255, null=True)),
